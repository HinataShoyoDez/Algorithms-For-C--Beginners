...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Console-Finding-Odd-Or-Even-Number\r");
        Console.WriteLine("------------------------\n");
        ...
        while (!endApp)
        {
            ...
            if (cleanNum1%2==0)
            {
                Console.WriteLine("Girdiğiniz sayı çifttir : " + cleanNum1);
            }
            else
            {
                Console.WriteLine("Girdiğiniz sayı tektir : " + cleanNum1);
            }
            Console.WriteLine("------------------------\n");
